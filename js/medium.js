...
console.log('click')
    ...
    function(){
      var selectedOption = this.options[category.selectedIndex];
      console.log(selectedOption.value + ': ' + selectedOption.text);
    });*/


    let postContent = document.querySelector('#inputGroupSelect01').value
    console.log(title, imgPerfil, author, date, readingTime, formFile, abstract, category, postContent)
    if(
        title !== '' &&
        imgPerfil !== '' &&
        author !== '' &&  
              ...
              <div class="col-md-9 ">
                <div class="card-body">
                  ...
                  <p class="card-text">${abstract}</p>
                     <div class="d-flex ">
                     <p class="card-text"><small class="text-muted">${readingTime} ${'min read'} ${date}</small></p>
